...
class SpectrogramDataset(Dataset, SpectrogramParser):
    def __init__(self, audio_conf, manifest_filepath, normalize=False, augment=False):
        """
        """
    ...
    def __getitem__(self, index):
        ...
        spect = self.parse_audio(audio_path, index=index)
...
class SpectrogramVerificationDataset(SpectrogramDataset):
    ...
    def __getitem__(self, index):
        ...
        spect_1 = self.parse_audio(audio_path_1)
        spect_2 = self.parse_audio(audio_path_2)
